	...
	public static class Guard
	{
		...
		public static void EnsureIsBasedOn<TType>(object argument)
		{
			...
			AgainstCondition(!(argumentType.BaseType == baseType),
				...
				.Args(argumentType.GetUnboxedName(), baseType.Name)));
		}
